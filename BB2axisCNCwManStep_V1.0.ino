...
#define XstpMM   (109) // Steps per MM on Y axis (17000 = 156 mm = Max width)
#define YstpMM   (97.8) // steps per MM on X azis (22000 = 225 mm = Max length)
// for arc directions
#define ARC_CW          (-1)
#define ARC_CCW         (1)
// Arcs are split into many line segments.  How long are the segments?
#define MM_PER_SEGMENT  (104) // actually steps per segment
